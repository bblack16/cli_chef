module CLIChef
  ...
  class SevenZip < CLIChef::Cookbook
    ...
    protected
      ...
      def setup_recipes
        @recipe_book.add_recipe Recipe.new 'list', ingredients: ({list:true, archive:nil, show_technical: true, include_archives: nil, disable_parsing: nil, exclude_archives: nil, include: nil, password:nil, recurse:nil, type:nil, exclude:nil}), required_input: [:archive]
        ...
        @recipe_book.add_recipe Recipe.new 'add', ingredients: ({add:true, type:'7z', include:nil, exclude:nil, recurse:nil, volumes:nil, working_dir:nil, password:nil, method:nil}), required_input: [:file, :output]
        ...
        @recipe_book.add_recipe Recipe.new 'extract', ingredients: ({extract_full_paths:true, extract:false, output:nil, type:nil, include:nil, exclude:nil, recurse:nil, include_archives:nil, exclude_archives:nil, password:nil, overwrite_mode:nil, stdout:false, assume_yes:true}), required_input: [:archive]
        ...
        @recipe_book.add_recipe Recipe.new :benchmark, ingredients:({benchmark:true})
        @recipe_book[:benchmark].description = 'Measures speed of the CPU and checks RAM for errors. No arguments required'
        @recipe_book.add_recipe Recipe.new :delete, ingredients:({delete:true, archive:nil, file:nil, include:nil, method:nil, password:nil, update_switch:nil, working_dir:nil, exclude:nil}), required_input: [:archive, :file]
        ...
        @recipe_book.add_recipe Recipe.new :test, ingredients:({test:true, archive:nil, file:nil, include:nil, include_archives:nil, password:nil, recurse:nil, disable_parsing:nil, exclude:nil, exclude_archives:nil}), required_input: [:archive]
        ...
        @recipe_book.add_recipe Recipe.new :update, ingredients:({update:true, archive:nil, file:nil, include:nil, password:nil, recurse:nil, stdout:nil, exclude:nil, stdin:nil, working_dir:nil, create_sfx:nil, compress_shared_files:nil, type:nil, update_switch:nil}), required_input: [:archive]
