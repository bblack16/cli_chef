  ...
  protected
    ...
    def setup_defaults
      ...
      add_ingredient(
        ...
        { name: :overwrite, description: 'Specifies the overwrite mode during extraction, to overwrite files already present on disk.', flag: '-ao', allowed_values: ['s', 'a', 'u', 't'], aliases: [:overwrite_mode], space: false },
